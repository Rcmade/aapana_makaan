import HomePagePropertySearchInput from "@/components/inputs/HomePagePropertySearchInput";
...
const HeroSection = () => {
  return (
    <div className="relative -mx-2 mb-8 bg-secondary pb-2 md:bg-transparent">
      <Container asChild>
      ...
      <div className="inset-0 px-2 md:absolute md:inset-auto md:bottom-16 md:left-16">
        <Suspense>
          <HomePagePropertySearchInput />
        </Suspense>
      </div>
    </div>
  );
